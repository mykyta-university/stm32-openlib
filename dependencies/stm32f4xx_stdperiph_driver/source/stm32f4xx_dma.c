...
@verbatim   
 ...
 ===============================================================================  
    [..]
    This subsection provides functions allowing to initialize the DMA Stream library
...
@verbatim   
 ...
 ===============================================================================  
    ...
    *** Interrupt Source ***
    ========================
    [..]
      (#) DMA_IT_FEIFx  : specifies the interrupt library for the  FIFO Mode Transfer Error event.
      (#) DMA_IT_DMEIFx : specifies the interrupt library for the Direct Mode Transfer Error event.
      (#) DMA_IT_TEIFx  : specifies the interrupt library for the Transfer Error event.
      (#) DMA_IT_HTIFx  : specifies the interrupt library for the Half-Transfer Complete event.
      (#) DMA_IT_TCIFx  : specifies the interrupt library for the a Transfer Complete event.
    [..]
    In this Mode it is advised to use the following functions:
...
/**
  ...
  * @param  DMAy_Streamx: where y can be 1 or 2 to select the DMA and x can be 0
  *          to 7 to select the DMA Stream.
  * @param  DMA_IT: specifies the DMA interrupt library to check.
  *          This parameter can be one of the following values:
