 ...
 *** Interrupts : ***
 ====================
 [..]   
   (#) HASH_IT_DINI  : if enabled, this interrupt library is pending when 16
       locations are free in the Data IN FIFO  which means that a new block (512 bit)
       can be entered into the input buffer. This interrupt library is cleared using
       HASH_ClearITPendingBit(HASH_IT_DINI) function.
   
   (#) HASH_IT_DCI   : if enabled, this interrupt library is pending when Digest
       calculation is complete. This interrupt library is cleared using
 ...
 *** Managing the HASH controller events : ***
 ...
 [..] The user should identify which mode will be used in his application to manage 
   ...
   (#)  In the Interrupt Mode it is advised to use the following functions:
       (++) HASH_ITConfig()       : to enable or disable the interrupt library.
...
/**
  ...
  * @param  HASH_IT: specifies the HASH interrupt library to be enabled or disabled.
...
/**
  ...
  * @param  HASH_IT: specifies the HASH interrupt library to check.
  *          This parameter can be one of the following values:
  *            @arg HASH_IT_DINI: Data Input interrupt
  *            @arg HASH_IT_DCI: Digest Calculation Completion Interrupt
