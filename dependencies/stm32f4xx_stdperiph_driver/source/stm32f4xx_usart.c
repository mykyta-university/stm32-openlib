    ...
    *** Interrupt Mode ***
    ...
    and 10 pending bits: 
      ...
      (#) Interrupt Source:
        ...
        (##) USART_IT_TXE : specifies the interrupt library for the Tx buffer empty
                            interrupt. 
        (##) USART_IT_RXNE : specifies the interrupt library for the Rx buffer not
                             empty interrupt.
        (##) USART_IT_TC : specifies the interrupt library for the Transmit complete
                           interrupt. 
        (##) USART_IT_IDLE : specifies the interrupt library for the Idle Line interrupt.
        (##) USART_IT_CTS : specifies the interrupt library for the CTS interrupt.
        (##) USART_IT_LBD : specifies the interrupt library for the LIN break detection
                            interrupt. 
        (##) USART_IT_PE : specifies the interrupt library for the parity error interrupt.
        (##) USART_IT_ERR :  specifies the interrupt library for the errors interrupt.

      -@@- Some parameters are coded in order to use them as interrupt library
          or as pending bits.
    [..]
    In this Mode it is advised to use the following functions:
...
/**
  ...
  * @param  USARTx: where x can be 1, 2, 3, 4, 5, 6, 7 or 8 to select the USART or 
  *         UART peripheral.
  * @param  USART_IT: specifies the USART interrupt library to check.
  *          This parameter can be one of the following values:
