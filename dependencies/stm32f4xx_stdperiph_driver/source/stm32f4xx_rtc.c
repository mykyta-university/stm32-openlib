...
@verbatim
 ...
 [..] The real-time clock (RTC), the RTC backup registers, and the backup 
      ...
      standby voltage supplied by a battery or by another library.
 ...
 [..] To enable access to the RTC Domain and RTC registers, proceed as follows:
   ...
   (+) Select the RTC clock library using the RCC_RTCCLKConfig() function.
 ...
 *** RTC Wakeup configuration ***
 ================================
 [..] 
   (+) Configure the RTC Wakeup Clock library use the RTC_WakeUpClockConfig()
       function.
 ...
 *** Backup Data Registers configuration ***
 ...
 [..] The RTC provides a programmable time base for waking up from the 
      ...
      Wakeup from STOP and Standby modes is possible only when the RTC clock library
      is LSE or LSI.
...
/**
  ...
  * @note   This function doesn't reset the RTC Clock library and RTC Backup Data
  *         registers.       
  * @param  None
...
/**
  * @brief  Configures the RTC Wakeup clock library.
  * @note   The WakeUp Clock library can only be changed when the RTC WakeUp
  *         is disabled (Use the RTC_WakeUpCmd(DISABLE)).      
  * @param  RTC_WakeUpClock: Wakeup Clock library.
  *          This parameter can be one of the following values:
...
void RTC_WakeUpClockConfig(uint32_t RTC_WakeUpClock)
{
  ...
  /* Clear the Wakeup Timer clock library bits in CR register */
  RTC->CR &= (uint32_t)~RTC_CR_WUCKSEL;

  /* Configure the clock library */
...
@verbatim   
 ...
 [..] This section provide functions allowing to configure the RTC Output library.
...
/**
  * @brief  Configures the RTC output library (AFO_ALARM).
...
/**
  ...
  * @param  RTC_IT: specifies the RTC interrupt library to check.
  *          This parameter can be one of the following values:
