 ...
 ===============================================================================
    [..]  This section provides functions allowing to:
      ...
      (+) ADC Continuous Conversion Mode (Continuous or Single conversion) for 
          regular group
      (+) External trigger Edge and library of regular group,
...
/**
  ...
  *         activation, continuous mode activation, External trigger library and
...
@verbatim   
 ...
 ===============================================================================  
    ...
    [..] A typical configuration to get the VBAT channel voltage is done following 
         these steps :
      (#) Enable the internal connection of VBAT library with the ADC channel using
 ...
 ===============================================================================  
    ...
    [..] This section provide functions allowing to configure the ADC Injected channels,
      ...
      (#) Configuration functions for Injected channels: This subsection provides 
        ...
        (++) Activate the Discontinuous Mode 
        (++) scan mode activation  
        (++) External/software trigger library
        (++) External trigger edge 
...
@verbatim   
  ...
  *** Flags and Interrupts for ADC regular channels ***
  =====================================================
    ...
    [..]
      (+) Interrupts :
        (##) ADC_IT_OVR : specifies the interrupt library for Overrun detection
             event.  
        (##) ADC_IT_EOC : specifies the interrupt library for Regular channel end
             of conversion event.
  ...
  *** Flags and Interrupts for ADC Injected channels ***
  ======================================================
    ...
    [..]
      (+) Interrupts :
        (##) ADC_IT_JEOC : specifies the interrupt library for Injected channel
  ...
  *** General Flags and Interrupts for the ADC ***
  ================================================ 
    ...
    [..]          
      (+) Interrupts :
        (##) ADC_IT_AWD : specifies the interrupt library for Analog watchdog event.
    ...
    [..] In the Interrupt Mode it is advised to use the following functions:
      (+) ADC_ITConfig()          : to enable or disable the interrupt library.
...
/**
  ...
  * @param  ADCx:   where x can be 1, 2 or 3 to select the ADC peripheral.
  * @param  ADC_IT: specifies the ADC interrupt library to check.
  *          This parameter can be one of the following values:
  *            @arg ADC_IT_EOC: End of conversion interrupt mask
  *            @arg ADC_IT_AWD: Analog watchdog interrupt mask
  *            @arg ADC_IT_JEOC: End of injected conversion interrupt mask
