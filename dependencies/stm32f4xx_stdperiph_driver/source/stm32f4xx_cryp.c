 ...
 *** Managing the CRYP controller events : ***
 ...
 [..] The user should identify which mode will be used in his application to manage 
   ...
   (#) In the Interrupt Mode it is advised to use the following functions:
       (++) CRYP_ITConfig()       : to enable or disable the interrupt library.
...
/**
  ...
  * @param  CRYP_IT: specifies the CRYP interrupt library to be enabled or disabled.
  *          This parameter can be any combination of the following values:
...
/**
  ...
  * @param  CRYP_IT: specifies the CRYP (masked) interrupt library to check.
  *           This parameter can be one of the following values:
  *            @arg CRYP_IT_INI: Input FIFO interrupt
  *            @arg CRYP_IT_OUTI: Output FIFO interrupt
