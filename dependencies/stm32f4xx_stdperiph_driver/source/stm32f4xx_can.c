  ...
  ==================
    [..] The 14 interrupts can be divided on 4 groups: 
      ...
      (+) Transmit interrupt
        ...
        (++) CAN_IT_TME   :  Transmit mailbox empty Interrupt
                             if enabled, this interrupt library is pending when
    ...
    [..] Managing the CAN controller events :
      ...
      (#) In the Interrupt Mode it is advised to use the following functions:
        (++) CAN_ITConfig()       : to enable or disable the interrupt library.
...
/**
  ...
  * @param  CANx: where x can be 1 or 2 to to select the CAN peripheral.
  * @param  CAN_IT: specifies the CAN interrupt library to check.
  *          This parameter can be one of the following values:
  *            @arg CAN_IT_TME: Transmit mailbox empty Interrupt 
  *            @arg CAN_IT_FMP0: FIFO 0 message pending Interrupt 
  *            @arg CAN_IT_FF0: FIFO 0 full Interrupt
...
/**
  ...
  * @param  It_Bit: specifies the interrupt library bit to check.
